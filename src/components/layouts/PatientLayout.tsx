...
export function PatientLayout({ children }: PatientLayoutProps) {
    ...
    const userName = user?.profile?.name || 'Paciente';
            ...
            <aside className="w-64 bg-white shadow-lg fixed h-full z-40">
                ...
                <div className="p-6 border-b border-medical-200">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-medical-500">Portal do Paciente</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="p-4 border-b border-medical-100">
                    <div className="flex items-center gap-3 p-3 bg-gradient-to-r from-primary-50 to-primary-100 rounded-xl">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-success-600 text-white mt-1">
                                Paciente
                            </span>
                        </div>
                    </div>
                        ...
                        {menuItems.map((item) => {
                            ...
                            return (
                                <li key={item.path}>
                                    ...
                                    >
                                        <span className={isActive ? 'text-white' : 'text-medical-400'}>
                                            {item.icon}
                                        </span>
                ...
                <div className="p-4 border-t border-medical-100">
                    <button
                        ...
                        className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-danger-600 hover:bg-danger-50 transition-all duration-200"
                    >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
